...
if C_AddOns.IsAddOnLoaded(target) then
	target = C_AddOns.GetAddOnMetadata(target, "Title") or target
end

Module:WaitUntil("DATA_LOCALE", function(self, event, ...)
	...
	L["CONFIG_LISTENCOLOR_STEP_TT"] =
		"The amount of time since you last heard someone via Listener for their color to change when you use the [rp:listencolor] tag."
